...
TESTCASE(allow_trailing_comma, object_no_element) {
  ...
  struct json_value_s* value = json_parse_ex(payload, strlen(payload), json_parse_flags_allow_trailing_comma, &result);
...
TESTCASE(allow_trailing_comma, object_one_element) {
  ...
  struct json_value_s* value = json_parse_ex(payload, strlen(payload), json_parse_flags_allow_trailing_comma, 0);
